...
export default function Contact(){
    ...
    return(
        ...
        <Particle />
            ...
            <Col md={6}>
            <Form onSubmit={handleSubmit} className="contactform w-[100%] md:w-[85%]">
                <h2 className="purple">Contact Me</h2>
                <div className="input-box">    
                    <label for="name">Name:</label>
                <input type="text" id="name" name="name" placeholder="Your name" required   value={formState.name}
                    onChange={handleChange} />
                </div>
                <div className="input-box">
                <label for="email">Email:</label>
                <input type="email" id="email" name="email" placeholder="Your email" required  value={formState.email}
                    onChange={handleChange} />
                </div>
                
                <div className="input-box textare-box">
                <label for="message">Message:</label>
                <textarea id="message" name="message" rows="5"  placeholder="Your message"  required   value={formState.message} onChange={handleChange}></textarea>
                </div>
            ...
            <Col md={6} className="flex justify-center items-center block md:hidden">
           ...
           <Col md={4} className='pt-[30px]'>
                <img src={Thumbnail} alt="thumbnail" className="thumbnaill
